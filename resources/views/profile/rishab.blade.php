...
@section('content')
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <i class="ace-icon fa fa-home home-icon"></i>
                <a href="{{ route('rishab') }}">Rishab Agrawal</a>
            </li>
        </ul><!-- /.breadcrumb -->
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{url('img/rishav.jpg')}}" />
															</span>
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <h4 class="blue">
                                            <span class="middle">Rishav agrawal</span>
                                        </h4>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span>rishavagrwal@gmail.com</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-user-info">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <a href="#" target="_blank">https://github.com/Rishav159</a>
                                                </div>
                                            </div>

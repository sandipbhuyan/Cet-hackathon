...
@section('content')
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <i class="ace-icon fa fa-home home-icon"></i>
                <a href="{{ route('rounak') }}">Rounak Samantray</a>
            </li>
        </ul><!-- /.breadcrumb -->
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{url('img/ronak.jpg')}}" />
															</span>
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <h4 class="blue">
                                            <span class="middle">Ronak samantray</span>
